				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
								<a class="btn btn-primary" href="{{route('jurusan.create')}}" role="button" >Tambah Data</a>
						</div>
					</div>
				</div>
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <td>
										...
										<button name="hapus" class="hapus btn btn-sm btn-outline-danger">Delete
										</button>
                                    </td>
								</tr>
                                @endforeach
		...
		$(document).on('click', '.hapus', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
					...
					var url = "{{ route('jurusan.destroy', ':data_id') }}";
